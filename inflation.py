    ...
    **Welcome to the Global Inflation Rate Prediction tool!**
    ...
    if uploaded_file is not None:
        ...
        if 'country_name' in data.columns and 'indicator_name' in data.columns:
            ...
            plot_type = st.selectbox("Select plot type:", ["Line Graph", "Bar Graph", "Correlation Heatmap", "Correlation Pairplot"])
            ...
            elif plot_type == "Correlation Pairplot":
                sns.pairplot(country_data, diag_kind="kde", markers='o', plot_kws={'alpha': 0.7})
                st.pyplot(plt)
